                                ...
                                <form class="cmxform form-horizontal " id="signupForm" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" type="submit" name="btn_sub">insert</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
{
    extract($_POST);
    $update=mysqli_query($conn,"insert into tb_add(id,date,place,message,reg_member) values('$id','$date','$place','$message','$reg_member')") or die (mysqli_error($conn));
    if($update)
    {
        echo "<script>";
