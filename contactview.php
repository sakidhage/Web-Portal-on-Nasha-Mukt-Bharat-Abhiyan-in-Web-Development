    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="index2.php"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <?php
    include "config.php";
	$add  = mysqli_query($conn,"select * from tb_info order by id desc") or die(mysqli_error($conn));
	?>
      <table class="table">
        <thead>
          <tr>
            ...
            <th data-breakpoints="xs">Addiction</th>
        ...
        <tbody>
				...
				<tr>
                    ...
                    <td><?php echo $row['addiction']; ?></td>
                    <td><?php echo $row['age']; ?></td>
					<td><?php echo $row['message']; ?></td>
					<td>
                        <a href="delete.php?stud_id=<?php echo $id; ?>">
                        <button type="button" name="submit">Delete</button>
                    </a>
                    <a href="contact_update.php?stud_id=<?php echo $id; ?>">
