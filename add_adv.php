...
$reg_member=$_POST['reg_member'];

$query="insert into  tb_add (id,date,place,message,reg_member) values(?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sss',$id,$date,$place,$message,$reg_member);
$stmt->execute();
echo"<script>alert('Advertisement has been added successfully');</script>";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Advertise </h2>
